...
//   return (
//     <div className="w-full h-[90vh] flex flex-col gap-4 overflow-hidden bg-background dark:bg-zinc-900 rounded-lg shadow-lg p-4">
...
//         <Card className="flex-1 min-w-0 flex flex-col bg-white dark:bg-zinc-800 shadow-md rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-700/60">
//           <CardHeader className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between bg-zinc-50 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-700/60">
...
//                   <TableHead className="dark:text-zinc-300">Cancella</TableHead>
//                   <TableHead className="dark:text-zinc-300">Edita</TableHead>
//                 </TableRow>
//               </TableHeader>
//               <TableBody>
...
//                           className="p-2 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-full"
//                         >
...
//         {/* Calendar only, no external box, fix width and allow content to be visible */}
//         <div className="w-full lg:w-[350px] flex-shrink-0 flex flex-col items-stretch lg:static relative z-10">
